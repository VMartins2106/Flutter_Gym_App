...
class TreinoWolf extends StatefulWidget {
  const TreinoWolf({super.key});

  @override
  State<TreinoWolf> createState() => _TreinoWolfState();
}

class _TreinoWolfState extends State<TreinoWolf> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: mostPopularWolf.length,
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                mostPopularWolf[index].classImage,
                                width: screenMedia.width * 0.6,
                                fit: BoxFit.cover,
                              ),
                            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      '${mostPopularWolf[index].className} - ${mostPopularWolf[index].classDifficult}',
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        mostPopularWolf[index].isFav 
                                        ? GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularWolf[index].isFav = false;
                                            });

                                            showSnackBar(context, mostPopularWolf[index], false);
                                        ...
                                        :GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularWolf[index].isFav = true;
                                            });

                                            showSnackBar(context, mostPopularWolf[index], true);
