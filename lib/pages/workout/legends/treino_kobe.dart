...
class TreinoKobe extends StatefulWidget {
  const TreinoKobe({super.key});

  @override
  State<TreinoKobe> createState() => _TreinoKobeState();
}

class _TreinoKobeState extends State<TreinoKobe> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: mostPopularKobe.length,
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                mostPopularKobe[index].classImage,
                                width: screenMedia.width * 0.6,
                                fit: BoxFit.cover,
                              ),
                            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      '${mostPopularKobe[index].className} - ${mostPopularKobe[index].classDifficult}',
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        mostPopularKobe[index].isFav 
                                        ? GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularKobe[index].isFav = false;
                                            });

                                            showSnackBar(context, mostPopularKobe[index], false);
                                        ...
                                        :GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularKobe[index].isFav = true;
                                            });

                                            showSnackBar(context, mostPopularKobe[index], true);
