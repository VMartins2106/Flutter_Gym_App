...
class TreinoJohann extends StatefulWidget {
  const TreinoJohann({super.key});

  @override
  State<TreinoJohann> createState() => _TreinoStateJohann();
}

class _TreinoStateJohann extends State<TreinoJohann>{
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      '${mostPopular[index].className} - ${mostPopular[index].classDifficult}',
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        mostPopular[index].isFav 
                                        ? GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopular[index].isFav = false;
                                            });

                                            showSnackBar(context, mostPopular[index], false);
                                        ...
                                        :GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopular[index].isFav = true;
                                            });

                                            showSnackBar(context, mostPopular[index], true);
