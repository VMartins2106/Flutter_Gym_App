...
class TreinoZyzz extends StatefulWidget {
  const TreinoZyzz({super.key});

  @override
  State<TreinoZyzz> createState() => _TreinoZyzzState();
}

class _TreinoZyzzState extends State<TreinoZyzz> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: mostPopularZyzz.length,
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                mostPopularZyzz[index].classImage,
                                width: screenMedia.width * 0.6,
                                fit: BoxFit.cover,
                              ),
                            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      '${mostPopularZyzz[index].className} - ${mostPopularZyzz[index].classDifficult}',
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        mostPopularZyzz[index].isFav 
                                        ? GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularZyzz[index].isFav = false;
                                            });

                                            showSnackBar(context, mostPopularZyzz[index], false);
                                        ...
                                        :GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularZyzz[index].isFav = true;
                                            });

                                            showSnackBar(context, mostPopularZyzz[index], true);
