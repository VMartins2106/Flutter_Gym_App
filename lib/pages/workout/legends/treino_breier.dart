...
class TreinoBreier extends StatefulWidget {
  const TreinoBreier({super.key});

  @override
  State<TreinoBreier> createState() => _TreinoBreierState();
}

class _TreinoBreierState extends State<TreinoBreier> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: mostPopularBreier.length,
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                mostPopularBreier[index].classImage,
                                width: screenMedia.width * 0.6,
                                fit: BoxFit.cover,
                              ),
                            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      '${mostPopularBreier[index].className} - ${mostPopularBreier[index].classDifficult}',
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        mostPopularBreier[index].isFav 
                                        ? GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularBreier[index].isFav = false;
                                            });

                                            showSnackBar(context, mostPopularBreier[index], false);
                                        ...
                                        :GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularBreier[index].isFav = true;
                                            });

                                            showSnackBar(context, mostPopularBreier[index], true);
