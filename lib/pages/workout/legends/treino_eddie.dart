...
class TreinoEddie extends StatefulWidget {
  const TreinoEddie({super.key});

  @override
  State<TreinoEddie> createState() => _TreinoEddieState();
}

class _TreinoEddieState extends State<TreinoEddie> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: mostPopularEddie.length,
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                mostPopularEddie[index].classImage,
                                width: screenMedia.width * 0.6,
                                fit: BoxFit.cover,
                              ),
                            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      '${mostPopularEddie[index].className} - ${mostPopularEddie[index].classDifficult}',
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        mostPopularEddie[index].isFav 
                                        ? GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularEddie[index].isFav = false;
                                            });

                                            showSnackBar(context, mostPopularEddie[index], false);
                                        ...
                                        :GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularEddie[index].isFav = true;
                                            });

                                            showSnackBar(context, mostPopularEddie[index], true);
