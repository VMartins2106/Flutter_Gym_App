...
class TreinoArnold extends StatefulWidget {
  const TreinoArnold({super.key});

  @override
  State<TreinoArnold> createState() => _TreinoArnoldState();
}

class _TreinoArnoldState extends State<TreinoArnold> {
  @override
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: mostPopularArnold.length,
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                mostPopularArnold[index].classImage,
                                width: screenMedia.width * 0.6,
                                fit: BoxFit.cover,
                              ),
                            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      '${mostPopularArnold[index].className} - ${mostPopularArnold[index].classDifficult}',
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        mostPopularArnold[index].isFav 
                                        ? GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularArnold[index].isFav = false;
                                            });

                                            showSnackBar(context, mostPopularArnold[index], false);
                                        ...
                                        :GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularArnold[index].isFav = true;
                                            });

                                            showSnackBar(context, mostPopularArnold[index], true);
