...
class TreinoRonnie extends StatefulWidget {
  const TreinoRonnie({super.key});

  @override
  State<TreinoRonnie> createState() => _TreinoStateRonnie();
}

class _TreinoStateRonnie extends State<TreinoRonnie>{
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: mostPopularRonnie.length,
                        ...
                        child: Stack(
                          children: [
                            ClipRRect(
                              ...
                              child: Image.network(
                                mostPopularRonnie[index].classImage,
                                width: screenMedia.width * 0.6,
                                fit: BoxFit.cover,
                              ),
                            ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      '${mostPopularRonnie[index].className} - ${mostPopularRonnie[index].classDifficult}',
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        mostPopularRonnie[index].isFav 
                                        ? GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularRonnie[index].isFav = false;
                                            });

                                            showSnackBar(context, mostPopularRonnie[index], false);
                                        ...
                                        :GestureDetector(
                                          onTap: () {
                                            setState(() {
                                              mostPopularRonnie[index].isFav = true;
                                            });

                                            showSnackBar(context, mostPopularRonnie[index], true);
